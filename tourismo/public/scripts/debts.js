$(document).ready(function(){
	...
	$("#categoriesSelect").selectize({
        ...
        onChange: function(){
            ...
            SearchDebts(term, $("#dstCountryTownSelect")[0].value,
	...
	$("#dstCountryTownSelect").selectize({
        ...
        onChange: function(){
            var term = this.items[0];
            SearchDebts($("#categoriesSelect")[0].value, term,
                $("#from_date")[0].value, $("#to_date")[0].value);
        }
    });
    ...
    $('#searchBtn').click(function(){
        SearchDebts($("#categoriesSelect")[0].value,
...
function SearchDebts(cat, dst, from, to)
{
    $.ajax({
        url: 'debtsSearch',
        type: 'POST',
