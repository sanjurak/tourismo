$(document).ready(function(){
	...
	$("#categoriesSelect").selectize({
        ...
        onChange: function(){
            ...
            SearchPromoters(term, $("#dstCountryTownSelect")[0].value,
	...
	$("#dstCountryTownSelect").selectize({
        ...
        onChange: function(){
            var term = this.items[0];
            SearchPromoters($("#categoriesSelect")[0].value, term,
                $("#from_date")[0].value, $("#to_date")[0].value);
        }
    });
    ...
    $('#searchBtn').click(function(){
        SearchPromoters($("#categoriesSelect")[0].value,
...
function SearchPromoters(cat, dst, from, to)
{
    $.ajax({
        url: 'basicPromotersSearch',
        type: 'POST',
        data: {
            cat_item: cat,
            dst_item: dst,
